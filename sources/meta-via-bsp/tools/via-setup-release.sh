...
cp sources/meta-via-bsp/meta-qsm8q60/conf/machine/* sources/meta-fsl-arm-extra/conf/machine
...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-via-bsp/meta-qsm8q60 \"" >> $BUILD_DIR/conf/bblayers.conf
...
echo "PREFERRED_PROVIDER_chromium = \"40.0.2214.91\"" >> $BUILD_DIR/conf/local.conf
echo >> $BUILD_DIR/conf/local.conf
